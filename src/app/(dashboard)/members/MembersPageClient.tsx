...
export function MembersPageClient({ initialData, searchParams }: Props) {
  ...
  const rows = raw.members.map((m) => ({
    ...
    group_id: m.group_id,
    locality_id: m.locality_id ?? null,
    age_group: m.age_group as Category | null,
    is_baptized: m.is_baptized,
    baptism_year: m.baptism_year ?? null,
    baptism_month: m.baptism_month ?? null,
    baptism_day: m.baptism_day ?? null,
    baptism_date_precision: m.baptism_date_precision ?? null,
    language_main: m.language_main ?? null,
    language_sub: m.language_sub ?? null,
    follower_id: m.follower_id ?? null,
